...
class TijdvakBepalerTest {
    ...
    public void testVerkortTijdvakBegin() {
        ...
        assertEquals(LocalDate.of(2016,3, 1), tijdvak1.getPeriode().getEinddatum());
        assertEquals(BigDecimal.valueOf(6), tijdvak1.getBedrag());
    ...
    @Test
    public void testVerkortTijdvakBeginEnEind() {
        // GIVEN
        Periode volledigTijdvak = new Periode(of(2016, 2, 2), of(2016, 5, 1));
        Periode verkortTijdvak = new Periode(of(2016, 2, 26), of(2016, 4, 8));
        Vordering vordering = new Vordering(BigDecimal.valueOf(47), volledigTijdvak, verkortTijdvak);
